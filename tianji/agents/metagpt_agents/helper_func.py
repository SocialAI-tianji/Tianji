...
def load_json(file_name):
    with open(os.path.join(TIANJI_PATH, "tianji", "agents", "metagpt_agents", file_name), 'r', encoding='utf-8') as file:
    # with open(r"tianji\agents\metagpt_agents\scene_combine.json", 'r', encoding='utf-8') as file:
...
def extract_all_types_and_examples(json_data):
    scene_types = json_data.get("scene_types", {})
    types_and_examples = {value["type"]: value["example"] for key, value in scene_types.items()}
