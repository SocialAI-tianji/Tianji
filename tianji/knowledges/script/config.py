...
class RQA_ST_Liyi_Chroma_Config:
    ...
    PERSIST_DIRECTORY = TIANJI_PATH + "/Tianji/tianji/knowledges/liyi/chroma"
    # Sentence-Transformer词向量模型权重位置
    HF_SENTENCE_TRANSFORMER_WEIGHT = "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"
