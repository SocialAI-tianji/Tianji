...
json_file_output_path为输出json文件的目录地址
...
'''
promptpath=r'C:\Users\yhd\PycharmProjects\Tianji\test\yiyan_prompt\07-Conflict\07-Conflict-陷入僵局如何重新建构对话.md'

input_dir, input_file = os.path.split(promptpath)
input_file_base, _ = os.path.splitext(input_file)

json_file_output_path =r"C:\Users\yhd\PycharmProjects\Tianji\tianji\prompt\yiyan_prompt\07-Conflict"
