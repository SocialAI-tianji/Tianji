...
with gr.Blocks() as demo:
    ...
    prev_button.click(
        fn=prev_md, outputs=[md_display, file_name_display, index_display]
    )
    next_button.click(
        fn=next_md, outputs=[md_display, file_name_display, index_display]
    )
    delete_button.click(
        fn=delete_md, outputs=[md_display, file_name_display, index_display]
    )
