...
class Config(metaclass=Singleton):
    ...
    def __init__(self, yaml_file=default_yaml_file):
        ...
        self.qwen_api_key = self._get("QWEN_API_KEY")
        self.baidu_api_key = self._get("BAIDU_API_KEY")
        if (not self.baidu_api_key or "YOUR_API_KEY" == self.baidu_api_key) and (not self.openai_api_key or "YOUR_API_KEY" == self.openai_api_key) and \
                ...
                (not self.qwen_api_key or "YOUR_API_KEY" == self.qwen_api_key) and \
                (not self.qwen_api_key or "YOUR_API_KEY" == self.baidu_api_key):
            raise NotConfiguredException("Set Baidu Key or OPENAI_API_KEY or Anthropic_API_KEY or ZHIPUAI_API_KEY first")
